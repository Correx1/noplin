        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 lg:gap-20 items-start">
          ...
          >
            <div className="flex flex-col gap-3">
              <span className="font-display text-[11px] font-semibold tracking-[0.14em] uppercase text-cyan-400">Who We Are</span>
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-3">
              <span className="font-display text-[11px] font-semibold tracking-[0.14em] uppercase text-cyan-400">Our Purpose</span>
            ...
            <div className="flex flex-col gap-6">
              {missionVision.map((item, i) => (
                <motion.div key={item.label} initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, ease: EASE, delay: i * 0.15 }}
                  className="flex flex-col sm:flex-row gap-5 px-6 py-8 bg-(--bg-card) rounded-lg" 
