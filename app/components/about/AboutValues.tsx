...
export default function AboutValues() {
  return (
    <section className="relative bg-(--bg-section-alt) py-28 sm:py-36 overflow-hidden">
        ...
        <div className="flex flex-col gap-0">
          {values.map((v, i) => (
            <motion.div
              ...
              className="group grid grid-cols-12 items-center gap-6 py-10 cursor-default border-t border-[var(--border-default)]"
            >
              {/* Number */}
