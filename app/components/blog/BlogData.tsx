...
posts[0].body = (
  <div className="flex flex-col gap-6">
    <p className="text-xl font-[var(--font-body)] leading-relaxed text-[var(--text-primary)] mb-8">
    ...
    <h2 className="font-[var(--font-display)] text-[var(--text-primary)] text-2xl font-bold mt-12 mb-6">The Cost of Moving Without Direction</h2>
    <p>
    ...
    <blockquote className="border-l-4 border-electric pl-6 my-10 italic text-[var(--text-primary)] font-medium bg-[var(--bg-section-alt)] py-4 pr-4 rounded-r-lg">
    ...
    <h3 className="font-[var(--font-display)] text-[var(--text-primary)] text-xl font-bold mt-10 mb-5">Structuring the Perfect Layout</h3>
    <p>
